...
我在上一段工作经历中参与的项目签有保密协议（NDA），相关专有代码与实验数据不在公开范围内，也不会出现在本账号下。

本账号所有仓库都是**公开开源项目的个人复现与工程记录**，与前雇主工作无交集，可以放心公开。仓库里没有涉密内容，只有我自己整理的环境笔记、排查记录，以及公开可查的上游参考基线——每一条都标了来源，能追溯回去。

我还没亲自跑完的部分会用「待补」标注，等自己复现出来再填，不会用别人的结果顶替。
